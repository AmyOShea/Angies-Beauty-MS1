...
Angie's Beauty is a business that specialises in beauty treatments for both face and body. This a real business that has an onilne presence through social media but doesn't currently have a website. 
...
## Design
### Colour Scheme
![Colours used](https://i.imgur.com/qYdOhRK.jpg)
...
* Original wireframes:
  * **Homepage** wireframes [here](https://i.imgur.com/0YVjo7m.png)  
  * **Treatments** wireframes [here](https://i.imgur.com/gmHxZ3D.png)  
  * **Contact Us** wireframes [here](https://i.imgur.com/vnI8AxI.png)

As the project progressed, there were changes to the homepage.
* Updated wirefeames:
  * **Homepage** wireframes [here](https://i.imgur.com/PqaPrQt.png)  
  * **Treatments** wireframes [here](https://i.imgur.com/VE4yDzW.png)  
  * **Contact Us** wireframes [here](https://i.imgur.com/ECShMyM.png)  
# Features
## Current Features
* All pages designed mobile-first and made to be fully responsive on all devices.
* Navigation meuu collapses on smaller screens for more compact design.
* Treatment information contained in a modal to reduce clutter on the page.
* Email address on contact page will open device email app (if installed).
* Phone number on contact page will open dialler app on mobile device.
## Future Features
* Form submission currently non-functional, can be made to work once JavaScript is learned. 
* An online booking system could be created linked directly to the business internal calender.
* A alert system can be added when there are new treatments available.
# Technologies Used
## Languages Used
...
* _As a user, I want to be able to understand the business brand at a first look_.
...
* _As a user, I want to be able to see the prices of products without having to search through various pages._
  * The price list is clear and visable on the home page. 

* _As a user, I want to be able to access information about the various beauty treatments available to me._
...
* _As a user, I want to be able to contact someone to ask about specific treatments and understand if they are appropriate for me._
...
* _As a user, I want to be able to be able to find the business location._ 
...
#### Computer
  ...
  * Lenovo 15" IdeaPad
    ...
    * Google Chrome
#### Responsinator
When there were devices/browsers that I didn't have access to, I used responsinator to make sure that the site was responsive.
### Third-Party Testing
...
![Imgur](https://i.imgur.com/ChBxiPU.png)
Overall I'm happy with the outcome of the perfomance review that I ran. There are a couple of issues that it showed:
* _Performance_
  * I decided to stick to the images that I already have rather than change the format. The JPG file sizes are quite small and the time saving was only __0.48s__, not enough for it to cause an issue.
* _Accessibility_
  * There isn't a h4 header between a h3 and h5 in some areas. I used the headers based on what they add visually to the page but I will keep this in mind for future projects. 
...
* _Best Practices_
  ...
  * The differences in the original and displayed image aspect ratio's on the treatment cards are miniscule and don't affect the UX. 
* _SEO_
...
### PowerMapper
I used PowerMapper to check how compatible the site was across different/older browsers that I didn't have access to. 
...
## Code
* Bootstrap example page was used as a skeleton when strating the NavBar used across all pages. This was then edied to what I needed. [This is the example that I used](https://getbootstrap.com/docs/4.0/examples/carousel/). Commented in HTML for clarity. 

* Bootstrap example page was used as a skeleton when starting treatments.html and the card layout. This was then edited to what I needed. [This is the example that I used](https://getbootstrap.com/docs/4.0/examples/blog/). Commented in HTML for clarity. 
